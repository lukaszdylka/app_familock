...
function renderDash() {
  ...
  // Average per session
  const avgRev = cnt > 0 ? sessionRevenueTotal() / cnt : 0;
  ...
  const thisMonthRev = thisMonth.reduce((s, x) => s + (Number(x.revenue) || 0), 0) + voucherRevenueForMonth(ym);
